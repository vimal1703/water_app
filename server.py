...
def workflow(image_url):
	...
	mask = np.squeeze(mask, axis=0)  # squeeze remove the single dimenational array 
	...
	image = image.convert('1') #convert an image to 1-bit black and white mode also known as binary 
